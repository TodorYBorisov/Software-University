...
async function register(email, password, gender) { // тук след регистрация да видя на къде се редиректва в задачата
...
function createSession({ _id, email, gender }) { //това е user обекта който сме направили по горе
