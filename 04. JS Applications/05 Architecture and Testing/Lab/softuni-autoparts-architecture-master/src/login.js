...
let ctx = null; //правим променлива на по горно ниво, за да може да я дотъпим по долу
...
async function onLogin({ email, password }) {//тия данни идват от addSubmitListenra горе
