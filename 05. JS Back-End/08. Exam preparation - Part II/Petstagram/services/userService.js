...
async function register(username, email, password) { // тук след регистрация да видя на къде се редиректва в задачата
...
function createSession({ _id, username, email }) { //това е user обекта който сме направили по горе
